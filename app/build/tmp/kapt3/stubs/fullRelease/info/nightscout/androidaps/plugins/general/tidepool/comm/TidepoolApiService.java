...
public abstract interface TidepoolApiService {
    ...
    @retrofit2.http.Headers(value = {"User-Agent: AAPS- 2.8.2-UAM-tsunami-0.6.1", "X-Tidepool-Client-Name: info.nightscout.androidapsinfo.nightscout.androidaps", "X-Tidepool-Client-Version: 0.1.0"})
